...
6. inalizar el ciclo, imprimir en consola la cantidad de números impares encontrados.
...
let numUsuario = parseInt(prompt("Ingrese un número (del 1 al 20): "));
let impares = 0;
...
console.log(`La cantidad de números impares desde 0 hasta ${numUsuario} (inclusive) es: ${impares}`);
